...
function init(initEvent) {
    ...
    function slideOne(slide) {
        ...
        function mouseCurtain(event) {
            ...
            if (event.clientX > event.view.innerWidth * 0.7) {
                slideOneTitleOne.innerHTML = "ANDA";
                slideOneTitleTwo.innerHTML = "ALISE";
            }
            if (event.clientX < event.view.innerWidth * 0.6) {
                slideOneTitleOne.innerHTML = "ALISE";
                slideOneTitleTwo.innerHTML = "DAGNIS";
            }
            if (event.clientX < event.view.innerWidth * 0.3) {
                slideOneTitleOne.innerHTML = "DAGNIS";
                slideOneTitleTwo.innerHTML = "ALISE";
            }
            ...
            if (complicated === false) {
                ...
                if (event.clientX > event.view.innerWidth * 0.52) {
                ...
                } else if (event.clientX < event.view.innerWidth * 0.52) {
                ...
                if (event.clientX > event.view.innerWidth * 0.65) {
                    for (h1 of h1Elements) {
                        if (h1.classList.contains('h1-blue')) {
                            h1.classList.replace('h1-blue', 'h1-white');
                        }
                    }
                } else if (event.clientX < event.view.innerWidth * 0.65) {
                    for (h1 of h1Elements) {
    ...
    const slideOneHtml = `
        <div class="slide slide-1">
            <div id="title">
                <h1 class="h1-blue slide-1-title slide-1-title-1 fadeInLeft">15 gadu pieredze</h1>
                <h1 class="h1-blue slide-1-title slide-1-title-2 fadeInRight">komunikācijas nozarē</h1> 
            </div>
            <div id="logo">
